...
type CreateUsersReq struct {
	UserType           int    `json:"user_type"`           // 用户类型， 对于创建的钱包用户的类型属性 0：未知 1：个人 2：企业
	Name               string `json:"name"`                // 用户名或者企业名称， 支持汉字以及大小写字母、空格
